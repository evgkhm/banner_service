...
func (mr *MockrepositoryMockRecorder) GetUserBanner(ctx, tagID, featureID, useLastVersion interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserBanner", reflect.TypeOf((*Mockrepository)(nil).GetUserBanner), ctx, tagID, featureID, useLastVersion)
}
